...
interface NotionLikeCourseEditorProps {
  setCourses: React.Dispatch<SetStateAction<Course[]>>;
  setState: (value: boolean) => void;
  onClose?: () => void;
}

const NotionLikeCourseEditor: React.FC<NotionLikeCourseEditorProps> = ({
  setCourses,
  setState,
  onClose,
}) => {
  ...
  const validateCourse = (): boolean => {
    ...
    // Validate course description (now compulsory)
...
export default NotionLikeCourseEditor;
